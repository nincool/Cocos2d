#ifndef _HR_MEMORYSTACKTOKEN_H_
#define _HR_MEMORYSTACKTOKEN_H_
...
#define HR_MEM_BLOCK_MAX_SAVE_BLOCK_SIZE		(1 * 1024 * 1024)
	...
	{
	public:
		CHrMemoryStackToken(int nBlockSize);
		~CHrMemoryStackToken();
	...
	public:
		...
		*/
		void*		Malloc(uint64 nSize, uint& nAllBlockCount, uint& nMemoryUse);
		/*
